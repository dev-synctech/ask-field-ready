...
export const ITEMS: ContentItem[] = [
  ...
  // ---------- Mizly Clip Batch 01 (learner-facing Mizly-created walkthroughs) ----------
  { id: "vc_orders_full_workflow", module_id: "m5", title: "Orders — full workflow map", summary: "Five plain-language steps to place any order: confirm patient + encounter, open Orders, pick type, review required fields, sign or route.", content_type: "video", tags: t("orders","workflow","mizly-clip"), difficulty: "foundational", estimated_minutes: 1, publish_status: "published", sanitized_approved: true, learner_video_url: "/videos/mizly-clips/orders-full-workflow-map.mp4", related_topic: "Orders workflow" },
  { id: "vc_notes_write_and_sign", module_id: "m5", title: "Notes — where to write and sign", summary: "Five plain-language steps to write any note: confirm encounter, open Notes, pick note type, complete starred sections, sign or route.", content_type: "video", tags: t("notes","documentation","mizly-clip"), difficulty: "foundational", estimated_minutes: 1, publish_status: "published", sanitized_approved: true, learner_video_url: "/videos/mizly-clips/notes-write-and-sign.mp4", related_topic: "Notes workflow" },
  { id: "vc_smartlink_blank_or_wrong", module_id: "m5", title: "SmartTools — SmartLink blank or wrong", summary: "Four checks before you escalate when a SmartLink is empty or pulled wrong data: encounter, refresh, prompt, owner.", content_type: "video", tags: t("smarttools","smartlink","documentation","mizly-clip"), difficulty: "foundational", estimated_minutes: 1, publish_status: "published", sanitized_approved: true, learner_video_url: "/videos/mizly-clips/smarttools-smartlink-blank-wrong.mp4", related_topic: "SmartTools" },
];
