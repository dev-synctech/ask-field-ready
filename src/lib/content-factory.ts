...
// Pack 13 internal visual reference map. Admin-only.
// Pointers to internal reference volumes/sections — NEVER expose PDFs or
...
const PACK13_REFERENCE_NEEDS: VisualNeed[] = [
  {
    ...
    conversionId: "cv_charge_billing_support",
    priority: "high",
    reason: "Pack 13 needs a sanitized sidebar/refresh/close-loop mock so claim-error orientation matches the answer card.",
    reference: { pdf: "Vol 1", section: "§1 / §2 / §4", refPattern: "V1-§1-* | V1-§2-* | V1-§4-*", use: "Sidebar orientation and refresh / check / close-loop steps.", exposureStatus: "needs cleaned callout before learner-facing" },
  },
  {
    workflowTitle: "Clearinghouse rejection / error",
    question: "Ask: clearinghouse rejection",
    conversionId: "cv_charge_billing_support",
    priority: "high",
    reason: "Need a sanitized rejection-location and corrected-claim path mock.",
    reference: { pdf: "Vol 1", section: "§2 / §4", refPattern: "V1-§2-* | V1-§4-*", use: "Rejection / error location and corrected claim workflow.", exposureStatus: "needs cleaned callout before learner-facing" },
  },
  {
    workflowTitle: "Coverage effective date issue",
    question: "Ask: coverage effective date",
    conversionId: "cv_charge_billing_support",
    priority: "high",
    reason: "Need a sanitized coverage/account screen mock with date-check callouts.",
    reference: { pdf: "Vol 1", section: "§3 / §8", refPattern: "V1-§3-* | V1-§8-*", use: "Coverage / account location and date checks.", exposureStatus: "needs cleaned callout before learner-facing" },
  },
  {
    workflowTitle: "Detail bill request",
    question: "Ask: detail bill request",
    conversionId: "cv_charge_billing_support",
    priority: "high",
    reason: "Need a sanitized account-access and detail-bill send-path mock.",
    reference: { pdf: "Vol 1", section: "§5 / §6 / §7", refPattern: "V1-§5-* | V1-§6-* | V1-§7-*", use: "Account access and detail bill send path.", exposureStatus: "needs cleaned callout before learner-facing" },
  },
  {
    workflowTitle: "Payment plan setup",
    question: "Ask: payment plan",
    conversionId: "cv_charge_billing_support",
    priority: "high",
    reason: "Need a sanitized plan create / activate / autopay flow mock.",
    reference: { pdf: "Vol 1", section: "§6 / §7", refPattern: "V1-§6-* | V1-§7-*", use: "Plan creation / activation / autopay flow.", exposureStatus: "needs cleaned callout before learner-facing" },
  },
  {
    workflowTitle: "Rounding workspace / patient list missing",
    question: "Ask: rounding workspace missing",
    conversionId: "cv_patient_list_worklist",
    priority: "high",
    reason: "Need a sanitized patient list / relationship / dashboard orientation mock.",
    reference: { pdf: "Vol 1", section: "§9", refPattern: "V1-§9-*", use: "Patient list / relationship / dashboard orientation.", exposureStatus: "needs cleaned callout before learner-facing" },
  },
  {
    workflowTitle: "Interactive view correction / uncharting",
    question: "Ask: iview correction uncharting",
    conversionId: "cv_documentation_notes_basics",
    priority: "high",
    reason: "Need a sanitized result-cell correction / unchart path mock.",
    reference: { pdf: "Vol 1", section: "§9", refPattern: "V1-§9-*", use: "IView result cell correction / unchart path.", exposureStatus: "needs cleaned callout before learner-facing" },
  },
  {
    workflowTitle: "Medication barcode scan failure",
    question: "Ask: med scan failure",
    conversionId: "cv_orders_entry_basics",
    priority: "high",
    reason: "Need a sanitized MAR / scan-failure decision support mock.",
    reference: { pdf: "Vol 1", section: "§9", refPattern: "V1-§9-*", use: "MAR / scan failure decision support.", exposureStatus: "needs cleaned callout before learner-facing" },
  },
  {
    workflowTitle: "Session information / profile-context troubleshooting",
    question: "Ask: session information",
    conversionId: "cv_login_access_support",
    priority: "medium",
    reason: "Need a sanitized session / profile / rule-context capture mock.",
    reference: { pdf: "Vol 2 Part A", section: "§1", refPattern: "V2-§1-*", use: "Session information / profile / rule context capture.", exposureStatus: "needs cleaned callout before learner-facing" },
  },
  {
    workflowTitle: "Schedule columns / personalization",
    question: "Ask: schedule columns",
    conversionId: "cv_patient_list_worklist",
    priority: "medium",
    reason: "Need a sanitized schedule personalization and column-setting path mock.",
    reference: { pdf: "Vol 2 Part A", section: "§2 / §3 / §4", refPattern: "V2-§2-* | V2-§3-* | V2-§4-*", use: "Schedule personalization and column setting path.", exposureStatus: "needs cleaned callout before learner-facing" },
  },
  {
    workflowTitle: "SmartLink blank or wrong",
    question: "Ask: smartlink blank",
    conversionId: "cv_documentation_notes_basics",
    priority: "high",
    reason: "Need a sanitized SmartLink / SmartText / SmartList comparison mock.",
    reference: { pdf: "Vol 2 Part B", section: "§5", refPattern: "V2-§5-*", use: "SmartLink / SmartText / SmartList difference and check path.", exposureStatus: "needs cleaned callout before learner-facing" },
  },
  {
    workflowTitle: "Patient portal proxy access",
    question: "Ask: portal proxy access",
    conversionId: "cv_login_access_support",
    priority: "high",
    reason: "Need a sanitized proxy relationship / access check mock.",
    reference: { pdf: "Vol 2 Part B", section: "§6", refPattern: "V2-§6-*", use: "Proxy relationship / access checks.", exposureStatus: "needs cleaned callout before learner-facing" },
  },
  {
    workflowTitle: "Patient portal result release",
    question: "Ask: portal result release",
    conversionId: "cv_results_reports_basics",
    priority: "medium",
    reason: "Need a sanitized release-delay / manual-release troubleshooting mock.",
    reference: { pdf: "Vol 2 Part B", section: "§6", refPattern: "V2-§6-*", use: "Result release delay / manual release / troubleshooting path.", exposureStatus: "needs cleaned callout before learner-facing" },
  },
  {
    workflowTitle: "Patient portal message routing",
    question: "Ask: portal message routing",
    conversionId: "cv_results_reports_basics",
    priority: "medium",
    reason: "Need a sanitized message type / folder / pool routing mock.",
    reference: { pdf: "Vol 2 Part B", section: "§6", refPattern: "V2-§6-*", use: "Message type / folder / pool routing checks.", exposureStatus: "needs cleaned callout before learner-facing" },
  },
  {
    workflowTitle: "Radiology scheduling / snapboard",
    question: "Ask: radiology scheduling snapboard",
    conversionId: "cv_patient_list_worklist",
    priority: "medium",
    reason: "Need a sanitized scheduling activity / snapboard appointment path mock.",
    reference: { pdf: "Vol 2 Part B", section: "§7", refPattern: "V2-§7-*", use: "Scheduling activity / snapboard appointment path.", exposureStatus: "needs cleaned callout before learner-facing" },
  },
  {
    workflowTitle: "Lab specimen collection",
    question: "Ask: lab specimen collection",
    conversionId: "cv_results_reports_basics",
    priority: "high",
    reason: "Need a sanitized collect-specimens / scanner / specimen-ID path mock.",
    reference: { pdf: "Vol 2 Part C", section: "§8", refPattern: "V2-§8-*", use: "Collect specimens / scanner / specimen ID path.", exposureStatus: "needs cleaned callout before learner-facing" },
  },
  {
    workflowTitle: "Lab verified result correction",
    question: "Ask: lab verified result correction",
    conversionId: "cv_results_reports_basics",
    priority: "high",
    reason: "Need a sanitized result-entry correction / safety path mock.",
    reference: { pdf: "Vol 2 Part C", section: "§8", refPattern: "V2-§8-*", use: "Result entry / correction safety path.", exposureStatus: "needs cleaned callout before learner-facing" },
  },
  {
    workflowTitle: "Ophthalmology exam section missing",
    question: "Ask: ophthalmology exam section missing",
    conversionId: "cv_documentation_notes_basics",
    priority: "medium",
    reason: "Need a sanitized exam layout / personal list / profile check mock.",
    reference: { pdf: "Vol 2 Part C", section: "§9", refPattern: "V2-§9-*", use: "Exam layout / personal list / profile checks.", exposureStatus: "needs cleaned callout before learner-facing" },
  },
  {
    workflowTitle: "Mobile clinical photo capture",
    question: "Ask: mobile clinical photo",
    conversionId: "cv_documentation_notes_basics",
    priority: "medium",
    reason: "Need a sanitized mobile photo capture / save / review path mock.",
    reference: { pdf: "Vol 2 Part C", section: "§10", refPattern: "V2-§10-*", use: "Mobile photo capture / save / review path.", exposureStatus: "needs cleaned callout before learner-facing" },
  },
  {
    workflowTitle: "Secure prescription printer",
    question: "Ask: secure prescription printer",
    conversionId: "cv_printer_triage",
    priority: "medium",
  ...
  status: "new" as const,
  title: "Visual reference mapped — sanitized mock needed",
  suggestedOutput: "Create a Mizly-original mock screenshot with numbered callouts. Use internal reference pointer (admin-only) to locate exact page in the page index; do not expose the reference PDF or cross-reference IDs to learners.",
