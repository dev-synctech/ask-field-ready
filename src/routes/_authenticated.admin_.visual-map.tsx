...
const SEED_ROWS: VisualMapRow[] = [
  ...
  // Next 5 — backlog
  {
    workflowId: "ll_p13_coverage_effective_date",
    workflowTitle: "Coverage effective date issue",
    exampleAsk: "Coverage effective date is wrong on the claim",
    visualStatus: "reference_found",
    calloutCount: 0,
    learnerVisible: false,
    qaStatus: "not_tested",
    notes: "Reference located. Needs cleaned mock of coverage panel + effective date field.",
  },
  {
    workflowId: "ll_p13_clearinghouse_error",
    workflowTitle: "Clearinghouse error",
    exampleAsk: "Claim rejected by clearinghouse — what now?",
    visualStatus: "reference_found",
    calloutCount: 0,
    learnerVisible: false,
    qaStatus: "not_tested",
    notes: "Need generic rejection reason panel mock.",
  },
  {
    workflowId: "ll_p13_med_scan_failure",
    workflowTitle: "Medication scan failure",
    exampleAsk: "Med barcode won't scan at the bedside",
    visualStatus: "reference_found",
    calloutCount: 0,
    learnerVisible: false,
    qaStatus: "not_tested",
    notes: "MAR scan failure mock, no PHI.",
  },
  {
    workflowId: "ll_p13_schedule_columns_personalization",
    workflowTitle: "Schedule columns / personalization",
    exampleAsk: "How do I change which columns show on my schedule?",
    visualStatus: "reference_found",
    calloutCount: 0,
    learnerVisible: false,
    qaStatus: "not_tested",
    notes: "Schedule personalization panel mock.",
  },
  {
    workflowId: "ll_p13_secure_rx_printer",
    workflowTitle: "Secure prescription printer",
    exampleAsk: "Secure prescription printer setup",
    visualStatus: "reference_found",
    calloutCount: 0,
    learnerVisible: false,
    qaStatus: "not_tested",
    notes: "Printer config screen mock.",
  },
];
