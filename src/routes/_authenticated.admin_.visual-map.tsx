...
const SEED_ROWS: VisualMapRow[] = [
  ...
  { workflowId: "ll_scope_orders", workflowTitle: "Orders — full workflow map", exampleAsk: "orders", visualStatus: "live_in_ask", visualPath: "/visual-guides/orders-scope-overview.svg", calloutCount: 5, learnerVisible: true, qaStatus: "not_tested", notes: "Broad-scope Mizly mock — patient header, activity rail, order search, type chips, composer, review/sign. No vendor logos, PHI, MRN, or org names." },
  { workflowId: "ll_scope_notes", workflowTitle: "Notes — full workflow map", exampleAsk: "notes", visualStatus: "live_in_ask", visualPath: "/visual-guides/notes-scope-overview.svg", calloutCount: 5, learnerVisible: true, qaStatus: "not_tested", notes: "Broad-scope Mizly mock — patient header, activity rail, note type chips, required sections composer, sign/save rail. No vendor logos, PHI, MRN, or org names." },
];
