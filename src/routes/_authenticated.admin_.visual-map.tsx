...
const SEED_ROWS: VisualMapRow[] = [
  ...
  // Pack 13 Visual Batch 3
  {
    ...
    workflowTitle: "IView correction / uncharting",
    exampleAsk: "IView correction uncharting",
    visualStatus: "live_in_ask",
    visualPath: "/visual-guides/iview-correction-uncharting.svg",
    calloutCount: 5,
    learnerVisible: true,
    qaStatus: "pass",
    notes: "Flowsheet correction mock — no PHI.",
  },
  {
    workflowId: "ll_p13_beaker_specimen_collection",
    workflowTitle: "Beaker specimen collection",
    exampleAsk: "Beaker specimen collection",
    visualStatus: "live_in_ask",
    visualPath: "/visual-guides/beaker-specimen-collection.svg",
    calloutCount: 5,
    learnerVisible: true,
    qaStatus: "pass",
    notes: "Generic collect-specimens mock.",
  },
  {
    workflowId: "ll_p13_beaker_verified_result_correction",
    workflowTitle: "Beaker verified result correction",
    exampleAsk: "Beaker verified result correction",
    visualStatus: "live_in_ask",
    visualPath: "/visual-guides/beaker-verified-result-correction.svg",
    calloutCount: 5,
    learnerVisible: true,
    qaStatus: "pass",
    notes: "Amendment-path mock, no result values.",
  },
  {
    workflowId: "ll_p13_radiant_snapboard_scheduling",
    workflowTitle: "Radiant scheduling / Snapboard",
    exampleAsk: "Radiant scheduling Snapboard",
    visualStatus: "live_in_ask",
    visualPath: "/visual-guides/radiant-scheduling-snapboard.svg",
    calloutCount: 5,
    learnerVisible: true,
    qaStatus: "pass",
    notes: "Generic scheduling-board mock, no patient names.",
  },
];
